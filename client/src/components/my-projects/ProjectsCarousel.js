      ...
      <Carousel.Item interval={12000}>
        ...
        <div className="container__slider-item">
          <div className="text__project-slider-item">
            ...
            <p><a href="https://life-organizer-by-colin.herokuapp.com/" target="_blank" rel="noreferrer">Visit the site</a> or <a href="https://github.com/colinstevens06/Life-Organizer" target="_blank" rel="noreferrer">view the repo</a>.</p>
          </div>
      ...
      <Carousel.Item interval={12000}>
        ...
        <div className="container__slider-item">
          <div className="text__project-slider-item">
            ...
            <a href="https://www.baltimorehappyhour.com/" target="_blank" rel="noreferrer">Visit the site</a>
          </div>
          <div className="image__project-slider-item">
      ...
      <Carousel.Item interval={12000}>
        ...
        <div className="container__slider-item">
          <div className="text__project-slider-item">
            ...
            <p><a href="http://liesfromgranny.com/" target="_blank" rel="noreferrer">Visit the site</a> or <a href="https://github.com/colinstevens06/Lies-From-Granny" target="_blank" rel="noreferrer">view the repo</a>.</p>
          </div>
          <div className="image__project-slider-item">
